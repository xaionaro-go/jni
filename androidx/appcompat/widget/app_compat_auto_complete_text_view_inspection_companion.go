...
// AppCompatAutoCompleteTextViewInspectionCompanion wraps androidx.appcompat.widget.AppCompatAutoCompleteTextView$InspectionCompanion.
type AppCompatAutoCompleteTextViewInspectionCompanion struct {
	VM  *jni.VM
	Obj *jni.GlobalRef
}
...
func (m *AppCompatAutoCompleteTextViewInspectionCompanion) MapProperties(arg0 *jni.Object) error {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midAppCompatAutoCompleteTextViewInspectionCompanionMapProperties == nil {
			callErr = fmt.Errorf("androidx.appcompat.widget.AppCompatAutoCompleteTextView$InspectionCompanion.mapProperties is not available on this device")
			return callErr
		}

		callErr = env.CallVoidMethod(
			m.Obj,
			midAppCompatAutoCompleteTextViewInspectionCompanionMapProperties, jni.ObjectValue(arg0),
		)
		return callErr
	})
	return callErr
...
// ToString calls androidx.appcompat.widget.AppCompatAutoCompleteTextView$InspectionCompanion.toString.
func (m *AppCompatAutoCompleteTextViewInspectionCompanion) ToString() (string, error) {
	var result string
	var callErr error
	callErr = m.VM.Do(func(env *jni.Env) error {
		if err := ensureInit(env); err != nil {
		...
		if midAppCompatAutoCompleteTextViewInspectionCompanionToString == nil {
			callErr = fmt.Errorf("androidx.appcompat.widget.AppCompatAutoCompleteTextView$InspectionCompanion.toString is not available on this device")
			return callErr
		}
		var resultObj *jni.Object
		resultObj, callErr = env.CallObjectMethod(
			m.Obj,
			midAppCompatAutoCompleteTextViewInspectionCompanionToString,
		)
		if callErr != nil {
			return callErr
		}
