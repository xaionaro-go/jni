...
// BasicMeasureMeasure wraps androidx.constraintlayout.core.widgets.analyzer.BasicMeasure$Measure.
...
func (m *BasicMeasureMeasure) ToString() (string, error) {
	...
	callErr = m.VM.Do(func(env *jni.Env) error {
		...
		if midBasicMeasureMeasureToString == nil {
			callErr = fmt.Errorf("androidx.constraintlayout.core.widgets.analyzer.BasicMeasure$Measure.toString is not available on this device")
			return callErr
		}
