...
func doInit(env *jni.Env) error {
	...
	if err != nil {
		...
		midOverlayInfoWriteToParcel, err = env.GetStaticMethodID((*jni.Class)(unsafe.Pointer(clsOverlayInfo)), "writeToParcel", "(Landroid/os/Parcel;I)V")
		if err != nil {
			// Method may not exist on this device's API level; skip and
			// report at invocation time instead of failing the entire init.
			env.ExceptionClear()
	...
	if err != nil {
		...
		midOverlayIdentifierWriteToParcel, err = env.GetStaticMethodID((*jni.Class)(unsafe.Pointer(clsOverlayIdentifier)), "writeToParcel", "(Landroid/os/Parcel;I)V")
		if err != nil {
			// Method may not exist on this device's API level; skip and
			// report at invocation time instead of failing the entire init.
			env.ExceptionClear()
	...
	if err != nil {
		...
		midOverlayManagerTransactionWriteToParcel, err = env.GetStaticMethodID((*jni.Class)(unsafe.Pointer(clsOverlayManagerTransaction)), "writeToParcel", "(Landroid/os/Parcel;I)V")
		if err != nil {
			// Method may not exist on this device's API level; skip and
			// report at invocation time instead of failing the entire init.
			env.ExceptionClear()
